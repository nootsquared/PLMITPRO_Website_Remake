...
export default function Home() {
  return (
    // Create a taller container that enables scrolling
    <div className="relative min-h-[200vh]">
      <Navbar className="top-2" />
      
      {/* Simple background with a gradient instead of parallax */}
      <div className="fixed inset-0 w-full h-full z-0 bg-gradient-to-b from-[#162F62] to-[#0d1d3d]"></div>

      {/* Main content with reduced top padding to bring content higher */}
      <main className="relative z-10 flex flex-col items-center pt-[15vh] min-h-screen">
        <div className="flex flex-col items-center w-full max-w-7xl mx-auto px-4 mb-20">
          <h1 className="text-5xl sm:text-9xl font-bold w-full text-center text-white">PLMITPro</h1>
        ...
        <div className="w-full bg-white py-32 mt-32">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-indigo-900 mb-8">Our Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Service cards */}
              {[1, 2, 3].map((item) => (
                <div key={item} className="bg-gray-50 p-6 rounded-lg shadow-md">
                  <h3 className="text-xl font-bold mb-2">Service {item}</h3>
        ...
        <div className="w-full bg-indigo-50 py-32">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <p className="text-lg text-gray-700 max-w-3xl">
              PLMITPro has been at the forefront of software implementation for over a decade. Our team of experts ensures that your enterprise's digital transformation is seamless and efficient.
            </p>
          </div>
        </div>
      </main>
